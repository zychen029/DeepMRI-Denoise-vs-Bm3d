...
class RESUNET(nn.Module):
    def __init__(self, args=None, in_chans = 1, out_chans = 1, chans = 256, num_pool_layers = 4, drop_prob = 0.0, nc=[64,128,256,512], nb=4, act_mode='R', downsample_mode='strideconv', upsample_mode='convtranspose', bias=True):
